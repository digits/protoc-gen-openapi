This is a fork of [google/gnostic/cmd/protoc-gen-openapi](https://github.com/google/gnostic/tree/main/cmd/protoc-gen-openapi) that
adds support for int64 types as well as better handling of proto message name collisions.
